...
const GPTSearchBar = () => {
  ...
  return (
    <div className="md:pt-[10%] pt-[60%] flex flex-col justify-center items-center md:flex-row md:justify-center ">
      <form
      ...
      >
        ...
        />
        <button
          className="col-span-3 m-4 px-4 text-white bg-red-700 rounded-lg"
